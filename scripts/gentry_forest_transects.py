...
U.S.A. """
    ...
    def download(self, engine=None, debug=False):
        ...
        self.engine.auto_create_table(Table(**{"name":"sites"}), url=self.urls["sites"], filename='gentry_sites.csv')
        ...
        table = Table(**{"name":"species", "delimiter":","})
        ...
        # Create stems table
        table = Table(**{"name":"stems", "delimiter":","})
        ...
        # Create counts table
        table = Table(**{"name":"counts", "delimiter":",", "contains_pk":False})

...
class main(Script):
    def __init__(self, **kwargs):
        ...
        self.citation = "Bloom, D., Wieczorek J., Russell, L. (2016).  VertNet_Fishes_Sept. 2016. CyVerse Data Commons. http://datacommons.cyverse.org/browse/iplant/home/shared/commons_repo/curated/VertNet_Fishes_Sep2016"
    ...
    def download(self, engine=None, debug=False):
        ...
        filename = 'vertnet_latest_fishes.csv'
        tablename = 'fishes'

        table = Table(**{"name": str(tablename), "delimiter":','})
        table.columns = [
            ("record_id", ("pk-auto",)),
            ("beginrecord", ("char",)),
            ("icode", ("char",)),

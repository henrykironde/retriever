...
class main(Script):
    ...
    def download(self, engine=None, debug=False):
        ...
        table_main = Table(**{"name":"main", "delimiter":',', "cleanup":self.cleanup_func_table})
        ...
        table_references = Table(**{"name":"references", "delimiter":',', "cleanup":self.cleanup_func_table})
        ...
        table_range = Table(**{"name":"range", "delimiter":',', "cleanup":self.cleanup_func_table})

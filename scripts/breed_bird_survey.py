...
class main(Script):
    ...
    def download(self, engine=None, debug=False):
        try:
            ...
            # Species table
            table = Table(**{"name": "species", Cleanup:Cleanup(), "contains_pk":True,
                          "header_rows":9})
            ...
            engine.auto_create_table(Table(**{"name": "routes", Cleanup:Cleanup()}),
                                     filename="routes.csv")
            ...
            engine.auto_create_table(Table(**{"name":"weather", "pk":"RouteDataId",
            ...
            # Region_codes table
            table = Table(**{"name":"region_codes", "pk":False, "header_rows":11,
            ...
            # Counts table
            table = Table(**{"name":"counts", "delimiter":','})

...
class main(Script):
    def __init__(self, **kwargs):
        ...
        self.description = "The data set contains relationships between predator and prey size which are needed to " \
    ...
    def download(self, engine=None, debug=False):
        ...
        engine.auto_create_table(Table(**{'name': 'main', "cleanup": self.cleanup_func_table}),

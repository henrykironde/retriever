...
class main(Script):
    ...
    def download(self, engine=None, debug=False):
        ...
        engine.auto_create_table(Table(**{'name':'sp_list', "cleanup":self.cleanup_func_table}),
        ...
        engine.auto_create_table(Table(**{'name':'ind_loc_girth', "cleanup":self.cleanup_func_table}),
